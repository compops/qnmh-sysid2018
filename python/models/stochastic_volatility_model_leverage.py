...
class StochasticVolatilityModelLeverage(BaseModel):
    ...
    def log_prior_gradient(self):
        ...
        """
        gradients = super(StochasticVolatilityModelLeverage, self).log_prior_gradient()
    ...
    def log_prior_hessian(self):
        ...
        """
        gradients = super(StochasticVolatilityModelLeverage, self).log_prior_gradient()
        hessians = super(StochasticVolatilityModelLeverage, self).log_prior_hessian()
