...
if (savePlotToFile) {
  ...
  cairo_pdf(fileName, height = 8, width = 8)}

layout(matrix(c(1, 1, 1, 2, 3, 4), 2, 3, byrow = TRUE))
par(mar = c(4, 5, 1, 1))

# Observations
grid <- seq(as.POSIXct("2015-11-07 01:00:00 CET"), as.POSIXct("2017-11-01 01:00:00 CET"), by = "1 day")
plot(
  as.Date(grid),
  obs,
  col = plotColors[1],
...
atVector1 = seq(as.POSIXct("2015-11-07 01:00:00 CET"), as.POSIXct("2017-11-07 01:00:00 CET"), by = "1 months")
atVector2 = seq(as.POSIXct("2015-11-07 01:00:00 CET"), as.POSIXct("2017-11-07 01:00:00 CET"), by = "6 months")
axis.Date(1, at=atVector1, labels=NA)
axis.Date(1, at=atVector2, format="%b %y",cex=0.75)
...
for (k in 1:3) {
  ...
  if (k==3) {prior_values = dgamma(prior_grid, 2.0, 10.0)}
